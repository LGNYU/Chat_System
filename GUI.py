...
class GUI:
    ...
    def login(self):
        ...
        # modidy from here 
        self.entrypassword=Label(self.login, text="Your password",font="Helvetica 12")
        self.entrypassword.place(relheight=0.2,relx=0.1,rely=0.4)
        self.EntryPass=Entry(self.login,font="Helvetica 14")
        self.EntryPass.place(relwidth=0.4, relheight=0.12, relx=0.5, rely=0.4)
        ...
        self.go.place(relx=0.4,
                      rely=0.8)
        self.str_warning=StringVar()
        self.label_warning=Label(self.login,textvariable=self.str_warning,font="Helvetica 14")
        self.label_warning.place(relheight=0.2,relx=0.1,rely=0.7)
    ...
    def layout(self, name):
        ...
        #msg = json.dumps({"action": "login", "game": name})
        #self.send(msg)
        #response = json.loads(self.recv())
